...
This script automates the process of collecting publicly available hotel data from Booking.com. Since bookin.com loads search results dynamically, the scraper uses Playwright’s asynchronous API to fully render the page before extracting information.
```{python}
#| eval: false 
import pandas as pd
